...
unsigned long o_flags[] = {
    O_APPEND, O_ASYNC, O_CLOEXEC, O_DIRECT, O_DIRECTORY, O_DSYNC, O_EXCL, O_LARGEFILE, O_NOATIME, O_NOCTTY, O_NOFOLLOW, O_NONBLOCK, O_NDELAY, O_PATH, O_SYNC, O_TMPFILE, O_TMPFILE, O_TRUNC};
char *o_flags_char[] = {
    "O_APPEND", "O_ASYNC", "O_CLOEXEC", "O_DIRECT", "O_DIRECTORY", "O_DSYNC", "O_EXCL", "O_LARGEFILE", "O_NOATIME", "O_NOCTTY", "O_NOFOLLOW", "O_NONBLOCK", "O_NDELAY", "O_PATH", "O_SYNC", "O_TMPFILE", "O_TMPFILE", "O_TRUNC"};
...
char *decode_argtype(char *sptr, unsigned long reg, enum argtype type)
{
    switch (type)
    {
    case ARG_PATHNAME:
...
void makeLogBuffer(struct syscallInfo *rec)
{
